...
export default function AIConsultingPage() {
  return (
    <div className="flex flex-col min-h-screen bg-gradient-to-br from-[#1e1e2f] to-[#2a2a4e] text-slate-50">
      {/* Navbar is client-side (dynamic) to avoid hydration/build issues */}
      <Navbar />
      ...
      <main className="py-12">
        ...
        <section className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
          ...
          <div className="text-center mt-8">
            <Link href="/services" className="inline-flex items-center gap-2 text-sm underline">
              ← Back to Services
            </Link>
          </div>
        </section>
      ...
      {/* Footer dynamic to avoid client-only issues */}
      <Footer />
    </div>
  );
}
