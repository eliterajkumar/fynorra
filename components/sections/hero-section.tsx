...
// Removed glowing effect and updated style directly
// You can update AnimatedWelcomeText if needed, but here's the simpler inline text version
// Or if keeping AnimatedWelcomeText, modify its className as shown below
    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20 bg-gradient-to-br from-[#0f172a] to-[#1e293b]">
      ...
      <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <div className="max-w-3xl mx-auto">
          {/* Replace or adjust AnimatedWelcomeText to remove glow */}
          <p className="text-xl sm:text-2xl md:text-3xl font-medium text-white text-center mb-6 md:mb-8">
            {heroWelcomeText}
          </p>
