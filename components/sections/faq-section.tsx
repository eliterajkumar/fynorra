...
const faqData: FAQItem[] = [
  {
    question: "How much does a custom AI chatbot cost to building Fynorra?",
    answer:
  ...
  },
  {
    ...
    answer:
      "Yes! Our AI chatbots are designed for seamless integration with your existing CRM, ERP, helpdesk, and other business systems. We support APIs, webhooks, and custom integrations for platforms like Salesforce, HubSpot, Zendesk, and more.",
    category: "Integration",
  },
  {
    question: "What makes Fynorra's AI solutions different from off-the-shelf options?",
    answer:
      "Unlike generic AI tools, our solutions are custom-built for your specific business needs, industry requirements, and customer interactions. We train models on your data, integrate with your workflows, and provide ongoing optimization to ensure maximum ROI.",
  ...
  },
  {
    ...
    answer:
      "Yes! Our advanced AI chatbots use natural language processing and machine learning to understand context, handle complex queries, and escalate to human agents when needed.",
    category: "Capabilities",
  },
  {
    question: "What industries do you specialize in?",
    answer:
      "We serve diverse industries including healthcare, finance, e-commerce, manufacturing, education, and professional services.",
    category: "Industries",
  },
  {
    question: "How do you measure the success of AI implementations?",
    answer:
      "We establish clear KPIs before implementation, including response times, resolution rates, customer satisfaction scores, and ROI metrics.",
    category: "Analytics",
  },
  {
    question: "What if we need to scale our AI solution as our business grows?",
    answer:
      "Our AI solutions are built with scalability in mind from day one. We design architectures that can handle increased traffic and add new features as your business expands.",
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-foreground/80 max-w-3xl mx-auto">
            Get answers to common questions about our AI solutions and
            development process.
          </p>
        </div>
